package online.westbay.trackingapp.mqtt.service;
...
import online.westbay.trackingapp.mqtt.impl.MqttConnectOptions;
import online.westbay.trackingapp.mqtt.impl.MqttException;
import online.westbay.trackingapp.mqtt.impl.MqttMessage;
import online.westbay.trackingapp.mqtt.impl.MqttPersistenceException;
import online.westbay.trackingapp.mqtt.impl.MqttTopic;
import online.westbay.trackingapp.mqtt.impl.paho.PahoMqttClientFactory;
import online.westbay.trackingapp.mqtt.interfaces.IMqttCallback;
...
import online.westbay.trackingapp.mqtt.interfaces.IMqttConnectOptions;
...
import online.westbay.trackingapp.mqtt.logging.ConfigureLog4J;
...
public class MqttService extends Service implements IMqttCallback {
    ...
    public static final String APP_ID = "online.westbay.trackingapp.mqtt";

    // constants used to notify the Activity UI of received messages    
    public static final String MQTT_MSG_RECEIVED_INTENT = "online.westbay.trackingapp.mqtt.MSGRECVD";
    public static final String MQTT_MSG_RECEIVED_TOPIC = "online.westbay.trackingapp.mqtt.MSGRECVD_TOPIC";
    public static final String MQTT_MSG_RECEIVED_MSG = "online.westbay.trackingapp.mqtt.MSGRECVD_MSG";

    // constants used to notify the Service of messages to send   
    public static final String MQTT_PUBLISH_MSG_INTENT = "online.westbay.trackingapp.mqtt.SENDMSG";
    public static final String MQTT_PUBLISH_MSG_TOPIC = "online.westbay.trackingapp.mqtt.SENDMSG_TOPIC";
    public static final String MQTT_PUBLISH_MSG = "online.westbay.trackingapp.mqtt.SENDMSG_MSG";

    // constants used to tell the Activity UI the connection status
    public static final String MQTT_STATUS_INTENT = "online.westbay.trackingapp.mqtt.STATUS";
    public static final String MQTT_STATUS_CODE = "online.westbay.trackingapp.mqtt.STATUS_CODE";
    public static final String MQTT_STATUS_MSG = "online.westbay.trackingapp.mqtt.STATUS_MSG";

    // constant used internally to schedule the next ping event
    public static final String MQTT_PING_ACTION = "online.westbay.trackingapp.mqtt.PING";
...
//        brokerHostName = "profile-staging.jackzz.net";
        brokerHostName = Constants.HOST_NAME;

//        topics.add(new MqttTopic("test"));
    ...
    public int onStartCommand(final Intent intent, int flags, final int startId) {
        ...
        // TODO move "topics" to a const value or something
        ArrayList<String> tops = intent.getStringArrayListExtra("topics");

        if(tops != null) {
            for (String t : tops) {
                topics.add(new MqttTopic(t));
            }
        }
        doStart(intent, startId);
