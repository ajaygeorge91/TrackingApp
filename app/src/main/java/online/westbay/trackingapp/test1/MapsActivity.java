package online.westbay.trackingapp.test1;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vehicleDTO = (VehicleDTO) getIntent().getSerializableExtra(VEHICLE_DTO);
    }
    ...
    public void onLocationChanged(Location location) {
        MqttServiceDelegate.publish(
                this,
                vehicleDTO.id,
                gson.toJson(new VehicleStatusDTO(vehicleDTO.id,location.getLatitude(),location.getLongitude(),location.getTime())).getBytes());
    }
